...
namespace GESTION_COLEGIAL.Business.Services
{
	...
	public class ParcialesService
	{
		...
		{
			string url = "Parciales/ListAsync";
		...
		{
			string url = "Parciales/FindAsync";
		...
		{
			string url = "Parciales/CreateAsync";
		...
		{
			string url = "Parciales/EditAsync";
		...
		{
			string url = "Parciales/ExistAsync";
		...
		{
			string url = "Parciales/RemoveAsync";
